...
| --- | --- | --- |
| [ResetRequest](ResetRequest.md) | A request to reset all the resolutions computed so far and possibly rebuild t... |  no  |
...
| [ResetResponse](ResetResponse.md) | A response to a `ResetRequest`, confirming that the rebuild process has start... |  no  |
